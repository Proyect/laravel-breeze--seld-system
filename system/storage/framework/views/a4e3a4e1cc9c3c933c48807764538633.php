        ...
        <h2>Registration Form</h2>
          <form id="registration-form" class="form" method= "POST">
            ...
            <div class="col">
              ...
              <input type="text" id="description" name="description" class="form-control w50" required>
            </div>
            </div>
            <div class="row">
              <div class="col">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\proyectos\php\laravel-breeze- adminlte\system\resources\views/products/index.blade.php ENDPATH**/ ?>